...
# Cell
@gif.frame
def plot_frame(param, img, pred, param_name="param",vmax=None, vmin=None, cmap=default_cmap,**kwargs):
    """
...
# Cell
def gif_series(series, fname, duration=150, param_name="param", vmax=None, vmin=None, cmap=default_cmap):
    """
